...
<div className="row my-3">
    ...
    <div className="row">
        <div className="col">
        <img src={require("https://images.unsplash.com/photo-1643316037362-e81fc45e6357?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMnx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=6")}/>
            <div className="w-100" alt ="home"></div>
                <div classname="col">
